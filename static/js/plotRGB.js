...
// Unsorted graph
d3.csv("/static/data/RGBUnsorted.csv").then(function(trainData) {
...
// Unsorted with noise
d3.csv("/static/data/RGBUnsortedNoise.csv").then(function(trainData) {
...
d3.csv("/static/data/RGBSorted.csv").then(function(testData) {
...
// Sorted with noise
d3.csv("/static/data/RGBSortedNoise.csv").then(function(testData) {
  console.log(testData);
